package com.devindie.stopusingshoppee.distractiongame.twozerogame;
...
import com.devindie.stopusingshoppee.distractiongame.twozerogame.snapshot.SnapshotData;
import com.devindie.stopusingshoppee.distractiongame.twozerogame.snapshot.SnapshotManager;
        ...
        signInClient.silentSignIn().addOnCompleteListener(this, new OnCompleteListener<GoogleSignInAccount>() {
            ...
            public void onComplete(@NonNull Task<GoogleSignInAccount> task) {
                if (!task.isSuccessful()) {
                    ...
                    SnapshotManager.loadSnapshot(MainActivity.this, data -> view.game.handleSnapshot(data));
                }
            }
        });
    }
